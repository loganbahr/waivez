...
export default function TailwindFooter() {
    return (
        <footer className="bg-gradient-to-br from-primary to-[#9f40ff]" aria-labelledby="footer-heading">
            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-8 xl:mt-0">
                        ...
                        <form className="mt-4 sm:flex sm:max-w-md">
                            ...
                            <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                                <button
                                    type="submit"
                                    className="w-full bg-secondary border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-primary hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2"
                                >
                                    Subscribe
                                </button>
                            </div>
                ...
                <div className="mt-8 border-t border-secondary pt-8 md:flex md:items-center md:justify-between">
                    ...
                    <p className="mb-2 text-center text-base text-secondary md:order-1">
                        &copy; {new Date().getFullYear()} Waivez, LLC. All rights reserved.
                    </p>

                    <div className="flex space-x-6 md:order-2 flex justify-center">
                        {navigation.social.map((item) => (
                            <a key={item.name} href={item.href} className="text-secondary hover:text-gray-300">
