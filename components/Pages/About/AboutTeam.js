        ...
        <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
          <div className="space-y-5 sm:space-y-4">
            ...
            <p className="text-xl text-gray-500">
              ...
              <span className={"text-primary font-medium"}>waivez</span> is just
              two developers — both graduates from Florida Gulf Coast University
              with Software Engineering degrees. Logan and Devin both grew up in
              Naples, Florida and still live there today.
            </p>
          </div>
              ...
              {people.map((person) => (
                <li key={person.name}>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1 text-lg leading-6 text-slate-900">
