...
const steps = [
  {
    ...
    description:
      "Our completed Prototype already has a lot of the core functionality required for a successful product launch. A user can search for a company, sign that companies waivers, and then view the waiver they signed. In essence, this is the core of what Waivez needs to do. Our next phases will improve on this functionality and allow Partners to interact and make use of this core feature.",
    status: "complete",
  },
  {
...
const AboutStepper = () => {
  return (
    <div className={"max-w-6xl mx-2 md:mx-auto"}>
      <h1
        className={
          "text-3xl tracking-tight my-10 mx-2 mt-6 md:mt-20 font-extrabold text-slate-900 md:text-4xl"
        }
      >
        Product Roadmap
      </h1>
              ...
              {step.status === "complete" ? (
                <>
                  ...
                  >
                    <span className="flex items-center h-9">
                      <span className="relative z-10 flex items-center justify-center w-8 h-8 rounded-full bg-primary group-hover:bg-primaryHover">
                        <CheckIcon
                ...
                <>
                  ...
                  >
                    ...
                    <span className="flex flex-col min-w-0 ml-4">
                      <span className="text-xl font-semibold tracking-wide uppercase text-primary">
                        {step.name}
                      </span>
                      <span className="text-lg text-gray-500">
                        {step.description}
                ...
                <>
                  ...
                  >
                    ...
                    <span className="flex flex-col min-w-0 ml-4">
                      <span className="text-xl font-semibold tracking-wide text-gray-500 uppercase">
                        {step.name}
                      </span>
                      <span className="text-lg text-gray-500">
                        {step.description}
