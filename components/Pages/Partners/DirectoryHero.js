            ...
            <div className={'w-3/4 mx-auto md:w-1/2 flex flex-col md:flex-row'}>
                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 746 721.34323">
                    ...
                    <path
                        ...
                        transform="translate(-227 -89.32838)" fill="#7f00ff"/>
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-227 -89.32838)" fill="#2f2e41"/>
                    <polygon points="212.904 695.94 225.042 700.278 247.551 655.523 229.636 649.121 212.904 695.94"
                             fill="#9f616a"/>
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-227 -89.32838)" fill="#cbcbcb"/>
                </svg>
                <div className={'md:my-auto my-2'}>
                    <h1 className={'text-slate-900 text-2xl md:text-4xl font-bold text-center md:text-start'}>
                        Find a partner, <br/> or become one yourself.
                    </h1>
                </div>
            </div>
