...
import TailwindWaiverForm from "../../components/Waivers/TailwindWaiverForm";
    ...
    return (
        <div>
            <div className={'flex flex-col max-w-7xl mx-2 xl:mx-auto'}>
                ...
                <h1 className={'mt-14 text-3xl text-center font-extrabold text-slate-900 sm:text-4xl lg:text-5xl'}>
                    {props.title}
                </h1>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 856.385 559.94">
                        <g id="Group_47" transform="translate(-171.808 -222.403)">
                            <g id="Group_43" transform="translate(-222.485 -67.725)">
                                <rect id="Rectangle_113" width="94.644" height="1.803"
                                      transform="translate(805.32 327.084)" fill="#ccc"/>
                                <rect id="Rectangle_114" width="300.158" height="1.803"
                                      transform="translate(431.249 327.084)" fill="#ccc"/>
                                <circle id="Ellipse_115" cx="36.956" cy="36.956" r="36.956"
                                        transform="translate(394.293 291.029)"
                                        fill="#7f00ff"/>
                                <circle id="Ellipse_116" cx="36.956" cy="36.956" r="36.956"
                                        transform="translate(562.85 291.029)"
                                        fill="#3f3d56"/>
                                <path id="Path_748-370"
                            ...
                            <g id="Group_24" transform="translate(808.073 222.403)">
                                ...
                                <path id="Path_553-374" d="M312.83,797.912H295.567l-8.212-66.584h25.477Z"
                                      transform="translate(-190.709 -256.191)" fill="#feb8b8"/>
                                <path id="Path_554-375"
                                ...
                                <path id="Path_555-376" d="M271.557,794.354l-17.178,1.69-14.7-65.458,25.355-2.491Z"
                                      transform="translate(-82.3 -257.51)" fill="#feb8b8"/>
                                <path id="Path_556-377"
                                ...
                                <ellipse id="Ellipse_84" cx="34.583" cy="34.583" rx="34.583" ry="34.583"
                                         transform="translate(92.343 13.688)" fill="#feb8b8"/>
                                <path id="Path_557-378"
                            ...
                            <rect id="Rectangle_110" width="737.385" height="2.19"
                                  transform="translate(290.808 780.153)" fill="#e6e6e6"/>
                            <path id="Path_438-383"
                            ...
                            <g id="Group_46" transform="translate(2 7)">
                                ...
                                <g id="Group_45">
                                    <circle id="Ellipse_18" cx="23.814" cy="23.814" r="23.814"
                                            transform="translate(512 378)"
                                            fill="#e6e6e6"/>
                                    <path id="Path_395-2-390"
                                          ...
                                          transform="translate(225.541 173)" fill="#7f00ff"/>
                                </g>
                            </g>
                        </g>
                    </svg>
                ...
                <p className="max-w-4xl text-center mx-auto my-4 text-xl text-slate-600 sm:mt-5 sm:text-2xl">
                                    ...
                                    <StepContent>
                                        ...
                                        >
                                                ...
                                                <button className=
                                                            {
                                                                ...
                                                                steps[step] === INITIALS && !initials ? "btn-disabled" : "btn-primary"
                                                            }
                                                        disabled=
                                                            {
                                                                steps[step] === ENTER_FORM && !formValid ||
                                            ...
                                            {steps[step] === SIGNATURE && (
                                                <button
                                                    className={!signature ? 'btn-disabled' : 'btn-primary'}
                                                    onClick={handleNext}
                                                    disabled={!signature}>
                                                    Sign Waiver
                                                </button>
