  ...
  return (
    <Box>
      <Container maxWidth="md" sx={{ mt: 16 }}>
        <Head>
          <title>waivez</title>
          <meta name="description" content="Any waiver, all in one spot." />
        </Head>
        <h1>waivez</h1>
        <SearchComboBox />
        <Box
        ...
        >
          ...
          >
            ...
            <br />
            <li />
            With the end of COVID-19, we want to make the return to travel and
            entertainment as easy as possible.
            <br />
            <li />
