...
export const connectToDatabase = async () => {
    return await MongoClient.connect(`mongodb+srv://${process.env.NEXT_PUBLIC_MONGO_PERSONAL_USER}:${process.env.NEXT_PUBLIC_MONGO_PERSONAL_PASS}@cluster0.uzbiq.mongodb.net/?retryWrites=true&w=majority`);
}
